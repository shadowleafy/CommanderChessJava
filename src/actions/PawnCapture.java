        ...
        switch(UI.stepsDone){
            ...
            case 2:
                if (UI.selectedSquares.size() != 0) {
                    ...
                    if (Utility.checkCaptureValidity(gameboard, getOwnerPiece(), UI.selectedPieces.get(0), Utility.formVector("1,1"), false, false,  false) ||
                        Utility.checkCaptureValidity(gameboard, getOwnerPiece(), UI.selectedPieces.get(0), Utility.formVector("-1,1"), false, false,  false)){
